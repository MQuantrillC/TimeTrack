    ...
    <div>
      <div className="flex flex-wrap items-end justify-between gap-x-4 gap-y-2">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-muted">Every stretch of work, newest first.</p>
        </div>
        {entries.length > 0 && (
          ...
          >
            ...
            <div className="flex items-baseline justify-between gap-3 sm:hidden">
              <span className="flex min-w-0 items-center gap-2">
                <span className="truncate text-sm font-medium text-ink">{entry.projectName}</span>
                {entry.running && (
